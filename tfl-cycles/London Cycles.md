...
Discovery 3: F12 on the page https://cycling.data.tfl.gov.uk/ reveals that URLs (requests) that I need have the following structure:
...
2.3 Calculation of the weekday cycle-km/km (cycling intensity) [B]
